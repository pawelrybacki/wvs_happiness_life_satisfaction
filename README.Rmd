...
output: md_document
---
This is my Harvard Stat 109 final project studying the main predictors of happiness and life satisfaction globally.
...
The main file `02_full_markdown.Rmd` is the markdown that conducts an analysis (using both code and text) of happiness and life satisfaction based on the longitudinal 1981-2014 [World Values Survey](www.worldvaluessurvey.org) data.

Using the original WVS data, the Stata script `01_prepare_dataset.do` prepares and cleans the final dataset (`wvs_happiness.dta`) used by `02_full_markdown.Rmd` in the analysis.